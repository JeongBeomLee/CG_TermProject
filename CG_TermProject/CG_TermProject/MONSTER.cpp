...
void MONSTER::init(int R, int G, int B, string str)
{
...
//--- 스케일 변환
void MONSTER::scaleTransform(float x, float y, float z)
{
	scale = glm::mat4(1.0f);
...
//--- 회전 변환
void MONSTER::rotateTransform(float x, float y, float z, float degree)
{
...
//--- 위치 변환
void MONSTER::moveTranform(float x, float y, float z)
{
	move = glm::mat4(1.0f);
...
RECT MONSTER::get_BB(float x, float z)
{
	RECT temp;
...
void MONSTER::changeColor(int R, int G, int B)
{
